...
import os
os.chdir(r"C:\Users\HP\Desktop\SilicoScientia\AntiFungal-Project3\MD_plots_R1_R2\VOR\DCCM")
covar = pd.read_csv(r'VOR_R1.dat', sep=' ', header=None)
...
np.savetxt("VOR_R1.csv", corr, delimiter=" ", fmt='%s')

# Draw the graph
file = np.loadtxt('VOR_R1.csv')
data = np.array(file)
...
fig.tight_layout()
fig.savefig('VOR_R1.jpeg', dpi=600, format='jpeg', pil_kwargs={'optimize':True, 'quality':80})